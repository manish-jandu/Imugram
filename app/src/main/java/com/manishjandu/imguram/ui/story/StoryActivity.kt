...
import com.manishjandu.imguram.databinding.ActivityStoryBinding
...
class StoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding.vpStory.adapter = storyPagerAdapter
        _binding.vpStory.registerOnPageChangeCallback(pageChangeCallback)
    }

    private val nextPageRunnable = Runnable{
        _binding.vpStory.currentItem++
    }
    ...
    private val pageChangeCallback = object : ViewPager2.OnPageChangeCallback() {
        override fun onPageSelected(position: Int) {
            ...
            _binding.progressView.animate().scaleX(1F)
                .setDuration(5000)
                .setStartDelay(10)
                .start()
